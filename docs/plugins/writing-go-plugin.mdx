...
```bash
go get github.com/petehanssens/drover-gateway/core@latest
```
...
require github.com/petehanssens/drover-gateway/core v1.2.38
```
...
- **All shared packages** (especially `github.com/petehanssens/drover-gateway/core`)
...
my-plugin.so: go1.26.1
  dep  github.com/petehanssens/drover-gateway/core  v1.3.50
...
bifrost-http: go1.26.1
  dep  github.com/petehanssens/drover-gateway/core  v1.3.54   # <-- MISMATCH!
...
go get github.com/petehanssens/drover-gateway/core@v1.3.54
go mod tidy
...
$ go version -m my-plugin.so | grep bifrost
  dep  github.com/petehanssens/drover-gateway/core  v1.3.54  # Now matches!
```
...
- **Full Example**: [examples/plugins/hello-world](https://github.com/petehanssens/drover-gateway/tree/main/examples/plugins/hello-world)
- **main.go**: [Plugin implementation](https://github.com/petehanssens/drover-gateway/blob/main/examples/plugins/hello-world/main.go)
- **Makefile**: [Build configuration](https://github.com/petehanssens/drover-gateway/blob/main/examples/plugins/hello-world/Makefile)
- **go.mod**: [Dependencies](https://github.com/petehanssens/drover-gateway/blob/main/examples/plugins/hello-world/go.mod)

## Real-World Plugin Examples

Explore production-ready plugins in the Bifrost repository:

- **[Mocker Plugin](https://github.com/petehanssens/drover-gateway/tree/main/plugins/mocker)** - Mock responses for testing
- **[Logging Plugin](https://github.com/petehanssens/drover-gateway/tree/main/plugins/logging)** - Advanced request/response logging
- **[Semantic Cache Plugin](https://github.com/petehanssens/drover-gateway/tree/main/plugins/semanticcache)** - Cache based on semantic similarity
- **[Governance Plugin](https://github.com/petehanssens/drover-gateway/tree/main/plugins/governance)** - Rate limiting and budget controls
- **[JSON Parser Plugin](https://github.com/petehanssens/drover-gateway/tree/main/plugins/jsonparser)** - Parse and validate JSON responses

## Frequently Asked Questions

### Do I need to rebuild my plugin when upgrading Bifrost?

**Yes, absolutely.** Plugins must be compiled against the exact same version of `github.com/petehanssens/drover-gateway/core` that Bifrost is using. This is a fundamental requirement of Go's plugin system.
...
go get github.com/petehanssens/drover-gateway/core@v1.3.0
go mod tidy
    ...
    steps:
      ...
      - name: Build Plugins
        run: |
          ...
          go get github.com/petehanssens/drover-gateway/core@${{ env.BIFROST_VERSION }}
          go mod tidy
          go build -buildmode=plugin -o my-plugin.so main.go
...
plugin was built with a different version of package github.com/petehanssens/drover-gateway/core
```
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/petehanssens/drover-gateway/issues)
