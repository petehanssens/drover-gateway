...
1.  **Fork and Clone**:
    *   Fork the repository: https://github.com/petehanssens/drover-gateway/
...
6. **Create Feature Files in Order of Complexity** (simplest first):
   ...
   **b. Create `embedding.go` (if supported)**:
   ...
   import schemas "github.com/petehanssens/drover-gateway/core/schemas"
...
- ✅ Import `github.com/petehanssens/drover-gateway/core/providers/openai`
...
import (
    // ... existing imports
    "github.com/petehanssens/drover-gateway/core/providers/[providername]"
)
```
