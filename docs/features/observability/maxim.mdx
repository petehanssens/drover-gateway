...
![Maxim Logs](https://github.com/petehanssens/drover-gateway/blob/main/docs/media/maxim-logs.png?raw=true)
...
import (
    ...
    maxim "github.com/petehanssens/drover-gateway/plugins/maxim"
)
