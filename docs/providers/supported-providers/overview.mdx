...
- "Rerank" refers to the Rerank API (`/v1/rerank`). See each provider page for model-specific requirements.
- "OCR" refers to the OCR API (`/v1/ocr`) for optical character recognition on documents and images.
