...
**Response**: [`BifrostVideoGenerationResponse`](https://github.com/petehanssens/drover-gateway/blob/main/core/schemas/videos.go) - `id`, `status`, `model`, `videos[]`
...
- [Bifrost Replicate Provider Source](https://github.com/petehanssens/drover-gateway/tree/main/core/providers/replicate)
