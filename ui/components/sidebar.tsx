...
const externalLinks = [
	...
	},
	{
		...
		url: "https://github.com/petehanssens/drover-gateway",
		icon: GithubLogoIcon,
	},
	{
		title: "Report a bug",
		url: "https://github.com/petehanssens/drover-gateway/issues/new?title=[Bug Report]&labels=bug&type=bug&projects=maximhq/1",
		icon: BugIcon,
		strokeWidth: 1.5,
	},
	{
